...
<body>
	...
	<form action="signUpProc" method="post" enctype="multipart/form-data"
		...
		<h2>SIGN UP</h2>
		<div class="textForm">
			<input type="email" class="id" name="m_email" placeholder="E-mail"
				id="signUpEmail" required> 
			<span id="emailCheckResult"></span>
		</div>
		<div class="textForm">
			<input type="password" class="pw" name="m_password"
		...
		<div class="textForm">
			<input type="text" class="phoneNumber" name="m_phoneNumber"
				placeholder="Phone number" required>
		</div>
		<div class="textForm">
			<input type="text" class="address" name="m_address"
		...
		<div class="photoUpload">
			<label class="profile" for="uploadButton">Profile</label>
			<input type="file" class="form-control" id="uploadButton">
		</div>
		<!-- 사진 올리기 끝 --> -->
		<button type="submit">
